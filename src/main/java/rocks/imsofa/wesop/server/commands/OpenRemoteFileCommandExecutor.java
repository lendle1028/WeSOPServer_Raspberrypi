...
public class OpenRemoteFileCommandExecutor implements CommandExecutor{
    ...
    public boolean canHandle(Command command) {
        ...
        return command.getGroupName().equals("rocks.imsofa.wesop.server.commands") && command.getName().equals("openRemoteFile");
    }
    ...
    public synchronized Object execute(Command command) throws Exception {
        ...
        }catch(Exception e){DebugUtils.log(OpenRemoteFileCommandExecutor.class, Level.SEVERE, ""+e+":"+e.getMessage());}

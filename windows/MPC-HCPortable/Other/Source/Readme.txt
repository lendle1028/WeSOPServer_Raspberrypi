...
user in an INI file next to MPC-HCPortable.exe called MPC-HCPortable.ini.
...
copy AppNamePortable.ini from this directory to MPC-HCPortable.ini next to
MPC-HCPortable.exe. The options in the INI file are as follows:
